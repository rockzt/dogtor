...
from .views import list_pet_owners, Test, OwnersList, Home, OwnersDetail, PetsList, PetsDetail, OwnersCreate, OwnersUpdate, PetsCreate, PetsUpdate, OwnersDelete, PetsDelete
