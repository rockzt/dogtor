...
from .views import list_pet_owners, Test, OwnersList, Home, OwnersDetail, PetsList, PetDetail, OwnersCreate, OwnersUpdate, PetsCreate, PetsUpdate, OwnersDelete, PetsDelete
